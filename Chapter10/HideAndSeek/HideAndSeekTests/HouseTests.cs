...
namespace HideAndSeekTests
{
    ...
    public class HouseTests
    {
        ...
        public void TestGetLocationByName()
        {
            ...
            Assert.AreNotEqual("Entry", House.GetLocationByName("Secret Library").Name);
        }
        ...
        public void TestRandomExit()
        {
            ...
            var backyard = new Location("Backyard");
            House.RandomExit(backyard);
        }
        ...
        public void TestHidingPlaces()
        {
            ...
            Assert.IsInstanceOfType(House.GetLocationByName("Entry"), typeof(Location));
            Assert.IsInstanceOfType(House.GetLocationByName("Landing"), typeof(Location));
            Assert.IsInstanceOfType(House.GetLocationByName("Hallway"), typeof(Location));
        }
